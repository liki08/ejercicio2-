...
mongoose.connect("mongodb+srv://nicolaslisker:7457790Ans@cluster0.mdbhh.mongodb.net/ejercicio2?retryWrites=true&w=majority").then(() => console.log("Conectado a MongoDB Atlas")).catch((error) => console.error(error));;
